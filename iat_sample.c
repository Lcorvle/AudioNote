...
void process(const char* audio_file, char *rec_result)
{
	int			ret						=	MSP_SUCCESS;
	// int			upload_on				=	1; //是否上传用户词表
	const char* login_params			=	"appid = 59f857f4, work_dir = ."; // 登录参数，appid与msc库绑定,请勿随意改动
	...
	*
	*/
	const char* session_begin_params	=	"sub = iat, domain = iat, language = en_us, accent = mandarin, sample_rate = 16000, result_type = plain, result_encoding = utf8";
